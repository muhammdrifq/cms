    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="">Tambah Peta</a>
                </li>
            </ul>
        </div>
        <div class="card">
            <div class="card-header">Tambah Peta</div>
            <form method="POST" action="{{ route('peta.store') }}" accept-charset="UTF-8">
                {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="alamat" class="form-control" name="alamat" rows="4" required
