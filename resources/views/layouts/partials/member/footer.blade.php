    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link text-white-50" href="{{ $setting->About_Us }}">About Us</a>
                <a class="btn btn-link text-white-50" href="{{ $setting->Contact_Us }}">Contact Us</a>
                <a class="btn btn-link text-white-50" href="{{ $setting->Our_Services }}">Our Services</a>
                <a class="btn btn-link text-white-50" href="{{ $setting->Privacy_Policy }}">Privacy Policy</a>
                <a class="btn btn-link text-white-50" href="{{ $setting->Terms_Condition }}">Terms & Condition</a>
            </div>
